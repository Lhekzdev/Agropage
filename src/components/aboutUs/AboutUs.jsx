...
const AboutUs = () => {
  return (
    <div  className="about-us-container font-georgia mb-6 w-full mt-[150px]">
      <div className="text-section">
        <h1 id="about-us" className='font-bold text-customBlack'>About Us</h1>
        <h2 className='subheader  text-customGreen font-bold text-xl'>“Our Commitment to Agriculture”</h2>
        <p>
        ...
        <button className="learn-more-btn hover:bg-customGreen" onClick={() => alert('Work in Progress')}>Learn More</button>
      </div>
