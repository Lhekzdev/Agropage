    ...
    return (
      <>
       ...
       <ol className='flex flex-wrap items-center justify-around'>
          ...
          <button className='h-12 w-40 border rounded-[18px] px-2 py-2 text-white bg-[#163518] text-lg font-normal font-Georgia' to="/getStarted">Get started</button>
          </li>
          ...
          <button className='w-full text-[22px] font-normal font-georgia text-center p-3  hover:bg-[#163518] hover:text-white transition-all cursor-pointer' to="/getStarted">Get Started</button>
          </div>
        </ol>
      </div>
      <Header/>
